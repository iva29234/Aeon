...
$("#guardar").click(function(){
     $.ajax({
		type: "POST",
		//url:"http://ivanapp.hol.es/AppProfesorCore/modificar1.php",
...
$('#botonmodificar').click(function (){
	...
	var id =  document.formmodificar.id.value;
	...
	$.ajax({
		...
		data: 'idData='+id+'strNombreData='+nombre+'&strApellidoData='+apellido+'&strDniData='+dni+'&refCategoriaData='+categoria,
